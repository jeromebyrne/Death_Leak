...
public:
	...
	virtual void SpawnNPC(const float posX, 
							...
							const Vector2 & dimensions = Vector2(100.0f, 100.0f),
							const Vector2 & collisionDimensions = Vector2(100.0f, 100.0f),
							const Vector2 & collisionBoxOffset = Vector2(0.0f,0.0f)) override;
