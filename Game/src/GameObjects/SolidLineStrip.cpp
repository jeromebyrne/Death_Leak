...
void SolidLineStrip::Draw(ID3D10Device * device, Camera2D * camera)
{
	// SolidMovingSprite::Draw(device, camera);
}

void SolidLineStrip::CalculateVariables()
{
	if (mStartPos.Y >= 0.0f)
	{
...
void SolidLineStrip::SetupDebugDraw()
{
...
bool SolidLineStrip::Intersect(Vector2 & otherStart, Vector2 & otherEnd, Vector2 & intersectPointOut)
{
